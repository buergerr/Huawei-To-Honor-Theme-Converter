...
from functions.saveActions import delete_description_xml, rename_description_xml, zip_workfolder466

class App(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Huawei to Honor WF 466 Converter")
        self.setGeometry(500, 500, 500, 500)
        self.text_edit = QTextEdit()
        self.button_upload = QPushButton("Upload 466 WF.hwt")
    ...
    def upload_hwt(self):
        ...
        if file_path:
            ...
            shutil.copyfile(os.path.join(self.assets_folder, "xml/wf466_description.xml"), os.path.join(self.work_folder, "source_description.xml"))
    ...
    def save(self):
        ...
        zip_workfolder466(self.work_folder, self.title_edit, self.designer_edit, self.version_edit, self.text_edit)
