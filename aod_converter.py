...
class App(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Huawei to Honor AOD Converter")
        ...
        self.old_aod_name = "com.huawei.aod"
        self.new_aod_name = "com.hihonor.aod"
        self.xml_text = None
        self.icon_file_name = "icons"
        self.icons_folder = "icon_workfolder"
        self.archive_format = "zip"  
        self.aod_folder = "com.hihonor.aod"
        self.assets_folder = "assets/"
        self.xmlNameConversionFile = "xmlNameConversions.csv"
        self.folders = ["com.hihonor.aod"]
        self.files_to_delete = ["com.hihonor.aod"]
    ...
    def upload_hwt(self):
        ...
        if file_path:
            ...
            # Call the resize aod cover function from imageManipulation.py
            resize_aod_cover(self.work_folder)
            ...
            shutil.copyfile(os.path.join(self.assets_folder, "xml/aod_source_description.xml"), os.path.join(self.work_folder, "source_description.xml"))
            ...
            replace_hwtheme_with_hntheme(self.folders)
